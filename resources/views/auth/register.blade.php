      ...
      <div class="card-body p-4">
        ...
        <div class="p-2 mt-4">
          <form action="{{ route('register') }}" method="POST">
            ...
            <div class="mb-3">
                <label for="rt_id" class="form-label">Select RT</label>
                <select name="rt_id" id="rt_id" class="form-select"></select>
            ...
            <div class="mt-4">
              <button class="btn btn-success w-100" type="submit" id="signup">Sign Up</button>
            </div>
